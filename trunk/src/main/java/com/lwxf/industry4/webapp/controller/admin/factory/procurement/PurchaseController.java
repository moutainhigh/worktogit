 ...
 */
@Api(value = "PurchaseController",tags = {"采购申请单管理接口"})
@RestController
...
public class PurchaseController {
	...
	@PostMapping
	@ApiOperation(value = "添加申请单",notes = "",response = PurchaseRequestDto.class)
    private String addPurchaseRequest(@RequestBody PurchaseRequestDto purchaseRequestDto){
        JsonMapper jsonMapper=JsonMapper.createAllToStringMapper();
    	RequestResult result=this.purchaseFacade.addPurchaseRequest(purchaseRequestDto);
    	return jsonMapper.toJson(result);
	}
	@PutMapping("/{purchaseRequestId}")
    @ApiOperation(value = "修改申请单",notes = "")
    private String updatePurchaseRequest(@PathVariable String purchaseRequestId,@RequestBody PurchaseRequestDto requestDto){
        JsonMapper jsonMapper=JsonMapper.createAllToStringMapper();
        RequestResult result=this.purchaseFacade.updatePurchaseRequest(purchaseRequestId,requestDto);
        return jsonMapper.toJson(result);
    }
	@PutMapping("/{purchaseRequestId}/end")
	@ApiOperation(value = "完成申请单",notes = "")
	private String endPurchaseRequest(@PathVariable String purchaseRequestId,@RequestBody MapContext mapContext){
		JsonMapper jsonMapper=JsonMapper.createAllToStringMapper();
		RequestResult result=this.purchaseFacade.endPurchaseRequest(purchaseRequestId,mapContext);
		return jsonMapper.toJson(result);
	}
	...
	@ApiOperation(value = "采购单生成入库单",notes = "")
