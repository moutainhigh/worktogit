...
@Component("sysExceptionFacade")
public class SysExceptionFacadeImpl extends BaseFacadeImpl implements SysExceptionFacade {

    @Resource(name = "sysExceptionService")
    private SysExceptionService sysExceptionService;

    @Override
    public RequestResult selectSysExceptionList(Integer pageNum, Integer pageSize, MapContext params) {
        ...
        PaginatedList<SysException> list = this.sysExceptionService.selectByFilter(filter);
