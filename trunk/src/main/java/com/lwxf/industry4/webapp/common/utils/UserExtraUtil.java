...
import com.lwxf.industry4.webapp.common.enums.MainAccountType;
...
public class UserExtraUtil {
	...
	public static String generateAppToken(UserExtra userExtra,RandomNumberGenerator rng){
		if(rng == null){
			rng = new SecureRandomNumberGenerator();
		}
		return MD5Util.textToMD5L32(new SimpleHash(LwxfShiroRealm.HASH_ALGORITHM, rng.nextBytes().toBase64(), userExtra.getPassword(), LwxfShiroRealm.HASH_INTERATIONS)
				.toBase64());
