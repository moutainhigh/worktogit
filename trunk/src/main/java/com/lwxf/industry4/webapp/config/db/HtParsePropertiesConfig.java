 ...
 * @create：2020-03-12 18:37
 * @version：1.0
 * @company：老屋新房 Created with IntelliJ IDEA
 */
@Configuration
@Profile("hterp")
public class HtParsePropertiesConfig {
    @Bean
    public static PropertyPlaceholderConfigurer encryptionPropertyPlaceholderConfigurer(){
        ...
        bean.setLocations(new ClassPathResource("application.properties"),new ClassPathResource("application-hterp.properties"));
        return bean;
    }
}
