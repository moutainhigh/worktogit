...
public class HuaWeiSendsms {
    ...
    private String hw_appKey ="";
    private String hw_appSecret ="";
    private String hw_templateId ="";
    private String hw_sender ="";
    private String hw_signature ="";
    private String hw_templateParas ="";
    ...
    public void alySms(String receivePhoneNumber) throws Exception {
...
//        String signature = "华为云短信测试"; //签名名称
       ...
       // String templateParas = "[\"369751\"]"; //模板变量
        ...
        String body = buildRequestBody(hw_sender, receivePhoneNumber, hw_templateId, hw_templateParas, statusCallBack, hw_signature);
        ...
        String wsseHeader = buildWsseHeader(hw_appKey, hw_appSecret);
