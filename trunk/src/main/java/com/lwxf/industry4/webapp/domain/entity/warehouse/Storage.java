...
public class Storage extends IdEntity  {
	...
	private String name;
	@Column(type = Types.INTEGER,length = 1,nullable = false,name = "type",displayName = "仓库类型")
	private String type;
	...
	private final static List<String> propertiesList = Arrays.asList("name","type","notes","storekeeper");
