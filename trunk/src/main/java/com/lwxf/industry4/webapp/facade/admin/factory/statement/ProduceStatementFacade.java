...
public interface ProduceStatementFacade extends BaseFacade {
	...
	RequestResult orderProduceCount(MapContext mapContext);

	RequestResult orderProduceTypeCount(MapContext mapContext);

	RequestResult orderProduceDelayCount(String branchId, String date);
}
