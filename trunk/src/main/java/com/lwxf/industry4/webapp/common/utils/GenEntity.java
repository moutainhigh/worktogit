...
public class GenEntity {
	 ...
	 * 数据库连接
	 */
	private static final String URL = "jdbc:mysql://192.168.3.4:3306/industry4_wisdom?useUnicode=true&characterEncoding=UTF-8";
	 ...
	 * 包的路径
	 */
	private String packageUrl = "com.lwxf.industry4.webapp.domain.entity.";
	/**
	 * 类输出路径
	 */
	private String outputPath = "E:\\workspace\\app\\codes\\lwxf_newstore\\trunk\\src\\main\\java\\com\\chuanghai\\easypm\\webapp\\domain\\entity\\";
	/**
	 * 表名
	 */
	...
	private String parse(String[] colnames, String[] colTypes, int[] colSizes) {
		...
		if (createExtendsIdEntity().length() > 0) {
			sb.append("import com.lwxf.industry4.webapp.domain.entity.base.IdEntity;\r\n");

		}
		sb.append("import com.lwxf.mybatis.utils.MapContext;\r\n");
		sb.append("import com.lwxf.industry4.webapp.common.result.RequestResult;\r\n");
		sb.append("import com.lwxf.industry4.webapp.common.result.ResultFactory;\r\n");
		...
		sb.append(" * @dept：老屋新房 Created with IntelliJ IDEA" + " \r\n");
		sb.append(" */ \r\n");
		//swagger表头注解
		sb.append("@ApiModel(value=\""+tablename+"对象\", description=\"" +tablename+"\")\r\n");
		//实体表注解
	...
	private void processAllAttrs(StringBuffer sb) {
		...
		for (int i = 0; i < colnames.length; i++) {
			...
			//生成swagger字段注解
			sb.append("\t@ApiModelProperty(value = \""+colDescs[i]+"\")\r\n");
			//生成外键注解
