...
@Configuration
@Profile("xhss")
public class XhssParsePropertiesConfig {
    @Bean
    public static PropertyPlaceholderConfigurer encryptionPropertyPlaceholderConfigurer(){
        ...
        bean.setLocations(new ClassPathResource("application.properties"),new ClassPathResource("application-xhss.properties"));
        return bean;
    }
}
