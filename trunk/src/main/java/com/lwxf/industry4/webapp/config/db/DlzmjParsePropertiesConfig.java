 ...
 *
 * @Auther: SunXianWei
 * @Date: 2020/07/09/14:44
 * @Description:
 */
@Configuration
@Profile("dlzmj")
public class DlzmjParsePropertiesConfig {
    @Bean
    public static PropertyPlaceholderConfigurer encryptionPropertyPlaceholderConfigurer(){
        ...
        bean.setLocations(new ClassPathResource("application.properties"),new ClassPathResource("application-dlzmj.properties"));
        return bean;
    }
}
