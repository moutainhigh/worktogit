 ...
 */
@Api(value="DealerChartController",tags={"F端后台管理接口:经销商报表接口"})
@RestController("DealerChartController")
@RequestMapping(value = "/wxdealer/DealerChartController/",produces = WebConstant.RESPONSE_CONTENT_TYPE_JSON_CHARTSET)
public class DealerChartController {
	...
	private String dealerStatements(@RequestParam(required = false) String startTime,
		...
		String uid = WebUtils.getUId();
		String branchId = WebUtils.getBId();
		if (uid == null) {
