 ...
 *
 * @Auther: SunXianWei
 * @Date: 2020/07/11/10:22
 * @Description:
 */
@Configuration
@Profile("fsec")
public class FsecParsePropertiesConfig {
    @Bean
    public static PropertyPlaceholderConfigurer encryptionPropertyPlaceholderConfigurer(){
        ...
        bean.setLocations(new ClassPathResource("application.properties"),new ClassPathResource("application-fsec.properties"));
        return bean;
    }
}
