...
@Configuration
@Profile("mmyl")
public class MmylParsePropertiesConfig {
    @Bean
    public static PropertyPlaceholderConfigurer encryptionPropertyPlaceholderConfigurer(){
        ...
        bean.setLocations(new ClassPathResource("application.properties"),new ClassPathResource("application-mmyl.properties"));
        return bean;
    }
}
