 ...
 */
@Component(value = "dealerLogisticsFacade")
public class DealerLogisticsFacadeImpl extends BaseFacadeImpl implements DealerLogisticsFacade {
    ...
    public RequestResult updateWxLogistics(MapContext mapContext) {
        ...
        if (mapContext.getTypedValue("checked", Byte.class).equals(1)) {
            // 其他地址取消默认选择
